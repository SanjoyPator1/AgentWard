...
export default function Slide19Status(_props: SlideProps) {
  return (
    <SlideLayout>
      ...
      <Panel>
        ...
        <ul className="space-y-2.5">
          <CheckRow>Synthetic patient data: 217 generated, all 217 loaded and verified</CheckRow>
          <CheckRow>Real FHIR server, resettable to a known state: HAPI plus Postgres</CheckRow>
          <CheckRow>fhir-mcp, two tool tiers: 3 Level 1 and 4 Level 2, stateless 2026-07-28 spec</CheckRow>
